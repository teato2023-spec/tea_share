...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    def _change_font_size(self, size_str):
        ...
        self._font_size = size
        for fn in [
            self.fn_strike, self.fn_sm, self.fn_bold,
            self.fn_mono, self.fn_mono_s,
        ]:
    ...
    def _setup_ui(self):
        ...
        tk.Label(
            top, text="  Learn_Type  ",
            bg="#2c3e50", fg="white", font=self.fn_bold
    ...
    def _build_practice_panel(self, parent: tk.Frame):
        ...
        self._mask_btn_full = tk.Button(
            ...
            command=lambda: self._toggle_mask("full"), bg="#dfe6e9", fg="#2c3e50", **_mb
        )
    ...
    def _create_sentence_window(self):
        ...
        self._inline_txt = tk.Text(
            _inner, height=2, font=self.fn_mono, wrap=tk.WORD,
    ...
    def _write_csv(self, path: str):
        """sentence_data 를 지정 경로에 CSV 로 저장하는 공통 헬퍼."""
        with open(path, "w", newline="", encoding="utf-8-sig") as f:
            w = csv.writer(f)
